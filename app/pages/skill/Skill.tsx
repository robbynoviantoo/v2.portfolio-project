...
import { SKILL_DATA } from "@/app/lib/skill-data";
        ...
        <div className="bg-white container dark:bg-zinc-950 text-zinc-900  dark:text-zinc-50 backdrop-blur-sm shadow-sm rounded-lg p-1 border border-white/40">
          <div className="overflow-hidden">
            <table className="w-full table-auto text-left border-collapse">
              <thead>
                <tr className="text-[18px] md:text-[22px] ">
              ...
              <tbody>
                {SKILL_DATA.map((row, index) => (
                  ...
                  >
                    <td className="py-3 px-4 font-medium text-[18px] text-zinc-500 md:text-[22px] border-r border-gray-300 border-dashed">
                      {row.category}
                    </td>
